\version "2.24.2"
MHT_title = "Macht hoch die Tür"
MHT_poet = "Text: Georg Weissel (1623)"
MHT_composer = "Melodie: Freylinghausensches Gesangbuch (1704)"
MHT_arranger = "Peter Crighton"
MHT_maintainerEmail = "PeteCrighton@googlemail.com"
MHT_maintainerWeb = "http://www.petercrighton.de"
MHT_copyright = "Public Domain"

MHT_akkorde = \chordmode {
  r4 es1. as2. bes
  as es bes es
  bes es c:m bes
  es c:m f bes
...
MHT_Score = \score {
  <<
    \new ChordNames \transpose es c { \MHT_akkorde }
    \new Voice = "Lied" \transpose es c { \MHT_melodie }
    \new Lyrics \lyricsto "Lied" { \MHT_text }
  >>
}
MHT_Strophen = \markup {
  \fill-line {
