\version "2.24.2"
VHH_maintainerEmail = "inguin@gmx.de"
VHH_title = "Vom Himmel hoch, da komm' ich her"
VHH_arranger = "Satz: Ingo van Lil"
VHH_composer = "Text und Musik: Martin Luther (1535)"
VHH_copyright = "CC BY 3.0"

VHH_melody = \relative c'' {
  \clef treble
  \key c \major
  \time 4/4
  \partial 8
...
VHH_Score = \score {
  <<
    ...
    \new Lyrics \lyricsto "sopran" \VHH_text
  >>
}
